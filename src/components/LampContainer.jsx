...
export const LampContainer = ({
  ...
  return (
    (<div
        className={`pt-40  relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-slate-950 w-full rounded-md z-0 ${className}`}
>
      <div
        ...
        <motion.div
          ...
          className="absolute inset-auto z-50 h-0.5 w-[10rem] -translate-y-[7rem] bg-cyan-400 "></motion.div>
